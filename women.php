...
?>
    ...
    <h1 class="section-title">Women Clothing</h1>
       
            <div class="product-container">
		<?php
		$query="select prod_id, prod_name, prod_img, price from product where category='Women' and quantity!=0";
		$result=mysqli_query($con, $query);
		foreach($result as $product){
		?>
                <div class="product-card">
                    <a href="product.php?product=<?= $product['prod_id']; ?>"><img src="product images/<?= $product['prod_img']; ?>" class="product-img" alt="error">
